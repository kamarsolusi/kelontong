      ...
      <div class="col-md-12">
        ...
        <div class="row">
          <?php if(!empty($flashsale)): ?>
            <?php foreach($flashsale as $key=> $value): ?>
              <div class="col-12 col-sm-6 col-md-3 mt-5">
                <div class="card">
                  ...
                  <div class="img-wrap">
                    <img class="card-img" src="<?= empty($value['picture_name'])? base_url('upload/products/no_image.png') : base_url('upload/products/'.$value['picture_name']) ?>" alt="<?= $value['picture_name'] ?>">
                  </div>
