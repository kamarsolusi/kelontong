        ...
        <div class="card">
            ...
            <div class="card-body table-responsive p-16" style="width: 100%;">
                <div class="row">
                    <div class="col-md-6">
                        <h1><?= $product['name'] ?></h1>
                        <h4 class="font-weight-bold text-muted" id="sku"><?= $product['sku'] ?></h4>
                ...
                <div class="row">
                    <div class="col-12">
                        <form action="<?= base_url('admin/pictures/process_upload') ?>" class="dropzone">
...
<script>
    ...
    $('.dropzone').dropzone({
        init: function(){
            myDropzone = this;
            $.ajax({
                url: "<?= base_url('admin/pictures/load') ?>",
                type: 'get',
                data: 'sku='+sku,
                dataType: 'json',
            ...
            myDropzone.on('dragend', function(file){
                $.ajax({
                    url: '<?= base_url('admin/pictures/process_upload') ?>',
                    method: 'post',
                    dataType: 'json',
                    success: function(response){
            ...
            myDropzone.on('removedfile', function(a) {
                ...
                var token = a.token;
                $.ajax({
                    url: '<?= base_url('admin/images') ?>/' + token,
                    method: 'delete',
                    dataType: 'json',
